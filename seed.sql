...
('Basil', 'Cleese', 'basil@kingwilliam.com'),
('Polly', 'Sherman', 'polly@kingwilliam.com'),
('Manuel', 'Torres', 'manuel@kingwilliam.com');

-- Insert room types
INSERT INTO room_type (type_name, base_rate) VALUES
('Single', 95.00),
('Double', 130.00),
('Suite', 165.00);

-- Insert rooms (15 singles across floors 2-4)
INSERT INTO room (room_type_id, room_number, floor_number, status) VALUES
-- Singles on floor 2
(1, '201', 2, 'Available'),
(1, '202', 2, 'Available'),
(1, '203', 2, 'Available'),
...
INSERT INTO seasonal_rate (room_type_id, start_date, end_date, rate_multiplier) VALUES
(1, '2025-06-01', '2025-09-01', 1.25), -- Singles in summer
...
INSERT INTO seasonal_rate (room_type_id, start_date, end_date, rate_multiplier) VALUES
(1, '2025-12-15', '2026-01-05', 1.30), -- Singles during holidays
(2, '2025-12-15', '2026-01-05', 1.25), -- Doubles during holidays
(3, '2025-12-15', '2026-01-05', 1.20); -- Suites during holidays

-- Insert services
INSERT INTO service (service_name, base_price, is_external) VALUES
('Restaurant', 0.00, false),
('LongDistance', 0.00, false),
